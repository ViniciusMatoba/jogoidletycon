import { HERO_CLASSES, BIOMES, ITEMS_INFO, PETS_CONFIG } from '../data/constants.js';
...
export class GameRenderer {
  ...
  loadImages() {
    const assetsList = {
      ...
      'monster_home_do_saco': 'assets/sprites/Home do Saco_universal.png?v=custom-boss-2',
      ...
      'monster_et_verde': 'assets/sprites/et verde_universal.png?v=custom-boss-2',
      ...
      'monster_saci_perere': 'assets/sprites/saci_perere_universal.png?v=custom-boss-2',
      ...
      'monster_capitao_orc':        'assets/sprites/monster_capitao_orc_universal.png?v=custom-boss-2',
      ...
      // Sprites de caminhada dos pets do gacha (Codex) — chave pet_walk_<id>
      ...Object.fromEntries(Object.entries(PETS_CONFIG).map(([id, p]) => [`pet_walk_${id}`, p.sprite])),
    };
  ...
  render(game, dt) {
    ...
    if (this.activeView === 'town') {
      ...
      // Pets invocados que seguem os heróis na cidade
      {
        const pets = Array.isArray(game.activePets) ? game.activePets : [];
        pets.forEach(pet => {
          if (!(Number.isFinite(pet.x) && Number.isFinite(pet.y))) return;
          renderList.push({
            y: pet.y + 3,
