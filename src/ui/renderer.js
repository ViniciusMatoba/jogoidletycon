...
export class GameRenderer {
  ...
  loadImages() {
    const assetsList = {
      ...
      'monster_home_do_saco': 'assets/sprites/Home do Saco_universal.png?v=custom-boss-1',
      ...
      'monster_et_verde': 'assets/sprites/et verde_universal.png?v=custom-boss-1',
      ...
      'monster_capitao_orc':        'assets/sprites/monster_capitao_orc_universal.png?v=custom-boss-1',
